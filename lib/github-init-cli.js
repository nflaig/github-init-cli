...
const create = async function(repositoyName) {
    ...
    try {
        ...
        console.log("Succesfully created GitHub repository " + `https://github.com/${username}/${repositoyName}.git`);
    } catch (error) {
        console.log(error);
    }
    ...
    console.log("Succesfully created local repository " + folderPath);
